(function () {
    ...
    TTS.prototype.tts = function (text, onended, lang) {
        ...
        var url = 'https://api.api.ai/api/tts?&access_token=' + _this.access_token + '&lang=' + lang + '&text='+ text;

        //xhr.open('GET', 'https://' + 'api.api.ai' + '/api/tts?access_token=' + _this.access_token + '&lang=' + lang + '&text=' + text, true);
