...
define([
    ...
    var Application = Backbone.Router.extend({
        ...
        initialize: function (interface_abstracts, interface_concretes, rules_lib, selection_rules, apiaiConf, conf) {
            Mira = requirejs('mira/init');

            this.configureApi(apiaiConf);
